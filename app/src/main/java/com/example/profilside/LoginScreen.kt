...
class LoginScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.login_knapp.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_loginScreen_to_navigation_home)

        }

        view.signin_knapp.setOnClickListener {
